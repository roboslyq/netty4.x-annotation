 ...
 */
public class EchoServerHandlerNotShared extends ChannelInboundHandlerAdapter {
    private static int CONSTANT_COUNT = 1;
    public EchoServerHandlerNotShared(){
    ...
    public void channelRead(ChannelHandlerContext ctx, Object msg) {
        ...
        ctx.writeAndFlush("EchoServerHandlerNotShared " + msg);
